...
const CHROME_EXTENSION_NOTICE_DISMISSED_KEY =
  "chrome_extension_notice_dismissed";
...
export const saveChromeExtensionNoticeDismissed = async () => {
  await SecureStore.setItemAsync(CHROME_EXTENSION_NOTICE_DISMISSED_KEY, "true");
};

export const getChromeExtensionNoticeDismissed = async () => {
  return SecureStore.getItemAsync(CHROME_EXTENSION_NOTICE_DISMISSED_KEY);
};
