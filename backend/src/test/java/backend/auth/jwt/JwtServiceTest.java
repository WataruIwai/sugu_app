...
class JwtServiceTest {
    ...
    void throwUnauthorizedWhenTokenIsTampered() {
        ...
        assertThrows(UnauthorizedException.class, () -> jwtService.extractUserIdFromHeader("Bearer" + tamperedToken));
    }
    ...
    void throwUnauthorizedWhenTokenIsExpired() {
        ...
        assertThrows(UnauthorizedException.class, () -> jwtService.extractUserIdFromHeader("Bearer" + token));
    }
}
